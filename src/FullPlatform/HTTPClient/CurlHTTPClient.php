...
namespace Ryan\FullPlatform\HTTPClient;

use Ryan\FullPlatform\Constant\Meta;
use Ryan\FullPlatform\Exception\CurlExecutionException;
 ...
 *
 * @package Ryan\FullPlatform\HTTPClient
 */
class CurlHTTPClient implements HTTPClient
{
    ...
    public function __construct($channelToken)
    {
        ...
        $this->userAgentHeader = [
            'User-Agent: Ryan-BotSDK-PHP/' . Meta::VERSION,
        ];
    }
    ...
    private function getOptions($method, $headers, $reqBody)
    {
        ...
        if ($method === 'POST') {
            if (is_null($reqBody)) {
                // Rel: https://github.com/line/full-platform-sdk-php/issues/35
